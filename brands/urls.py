...
urlpatterns = [
    ...
    path('brands/<int:pk>/detail/', views.BrandDatailView.as_view(), name='brand_detail'),
    ...
    path('api/v1/brands/<int:pk>/', views.BrandRetriveUpdateDestroyApiView.as_view(), name='brand-retrive-update-destroy-api-view')
]
